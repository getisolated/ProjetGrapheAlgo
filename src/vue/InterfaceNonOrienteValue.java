...
public class InterfaceNonOrienteValue extends JPanel {
	...
	public InterfaceNonOrienteValue() {
		...
		coloration.setBackground(new Color(47,47,47));
		...
		afficherGrapheColoration.setBackground(new Color(47,47,47));
		afficherGrapheColoration.setForeground(Color.WHITE);
